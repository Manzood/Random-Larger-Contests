...
// final edit: I've failed to implement it at the moment, but I probably should learn this one in the future
// going to try and implement aho-corasick before time runs out
// for each vertex, I should probably have a "next" vertex ready
